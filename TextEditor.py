...
а также вычисляет простые арифметические выражения, встречающиеся в тексте,
с учетом приоритета операций (возведение в степень, умножение, деление,
целочисленное деление, остаток от деления, сложение, вычитание).
"""
